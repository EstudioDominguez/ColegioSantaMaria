...
<table border="0" cellpadding="0" width="860" id="table1" style="background-repeat: no-repeat; background-position: right bottom">
	<tr>
		<td style="background-position: right bottom; padding-left: 20px; background-image:url('../institucional/imagenes_noticias/fondo_noticias.jpg'); background-repeat:no-repeat; background-attachment:scroll; padding-right:20px" valign="top">
		<table border="0" cellpadding="0" width="98%" id="table2" cellspacing="10">
			<tr>
				...
				<table border="0" cellpadding="0" id="table4">
				    ...
				    <?php if($emailSent == true ): ?>				            
				            <h3> <font color="#008000">Gracias por suscribirse. </font></h3>
					<h3> <font color="#008000">Estar&aacute; recibiendo nuestras pr&oacute;ximas novedades en breve.</font></h3>
					<h3> &nbsp;</h3>
					<h3> &nbsp;</h3>
					<h3> &nbsp;</h3>
					<h3> &nbsp;</h3>
					...
					<tr>
						...
						<form method="POST" action="alta_noticias.php" webbot-action="--WEBBOT-SELF--">
							<!--webbot bot="SaveResults" U-File="D:\sitios web\_private\form_results.csv" S-Format="TEXT/CSV" S-Label-Fields="TRUE" startspan --><input TYPE="hidden" NAME="VTI-GROUP" VALUE="0"><!--webbot bot="SaveResults" i-checksum="43374" endspan --><table border="0" cellpadding="0" width="653" id="table5">
								<tr>
				...
				<td valign="top" width="184" class="textos"><p>&nbsp;<p>&nbsp;<table border="0" cellpadding="0" id="table6" style="padding: 20px" bgcolor="#808080">
					<tr>
