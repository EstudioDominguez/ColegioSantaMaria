...
<!-- --------------------------------------------------------------------------------------------DIV contenedor -------------------------------- -->
      <div class="row marketing" style="min-height:570px ">
		...
		<div class="col-md-12">
		    ...
		    <div id="div-1a" style="position: absolute; left: 451px; top: 0px; width: 226px; height: 560px">
          			<!-- --------------insertp html ---------------- -->		  	
		  			<object type="text/html" data="http://colegiosantamaria.com.ar/web/_editables/_aviso.htm"
	            		style="width:105%; height:138%; margin:0%">
		  			</object>
					<!-- --------------insertp html ---------------- -->
        	</div>		
...
<!-- -------------------------------------------------------------------------------------------- fin DIV contenedor ---------------------------- -->
      <div class="footer">
        <a href="http://www.colegiosantamaria.com.ar/web">
        <img src="http://www.colegiosantamaria.com.ar/web/assets/images/news_bottom.jpg" width="700" height="115"></a>
      </div>
