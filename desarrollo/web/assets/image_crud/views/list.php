	...
	<?php foreach($photos as $photo_num => $photo){?>
			<li id="photos_<?php echo $photo->$primary_key; ?>">
				<div class='photo-box'>
					...
					<?php if($title_field_input != null){ ?>
					<div class="text-center" style="width: 80px; display: inline-block; text-align: center; padding: 5px;">
						<?php echo $photo->$title_field_input; ?>	
					</div>						
					<div class="clear"></div>
					<?php }?>					
