...
class image_CRUD {
	...
	protected $priority_field_input = null;
	protected $url_field = 'url';
	protected $title_field = null;
	protected $title_field_input = null;
	...
	function set_ordering_field_input($field_name)
	{
		$this->priority_field_input = $field_name;
	...
	function set_title_field_input($title_field_input)
	{
		$this->title_field_input = $title_field_input;
    ...
    protected function _get_delete_url($value)
    {
		...
		$modulo = $this->ci->uri->segment_array();
    	return site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/delete_file/'.$value);
    }
    ...
    protected function _get_photos($relation_value = null)
    {
		...
		if(!empty($this->priority_field_input))
    	{
    		$this->ci->db->order_by($this->priority_field_input);
    	}		
	...
	protected function getState()
	{
		...
		//print_r($rsegments_array);
		
		//print_r($modulo);exit;

		if(isset($rsegments_array[3]) && is_numeric($rsegments_array[3]))
		{
			$upload_url = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/upload_file/'.$rsegments_array[3]);
			$ajax_list_url  = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/'.$rsegments_array[3].'/ajax_list');
			$ordering_url  = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/ordering');
			$insert_title_url  = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/insert_title');
		...
		{
			$upload_url = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/upload_file');
			$ajax_list_url  = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/ajax_list');
			$ordering_url  = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/ordering');
			$insert_title_url  = site_url($rsegments_array[1].'/'.$modulo[2] . '/' . $rsegments_array[2].'/insert_title');
